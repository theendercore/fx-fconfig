 ...
 * @since 0.2.0
 */
class ClickableTextWidget(message: Text, textRenderer: TextRenderer): CustomTextWidget(0, 0, textRenderer.getWidth(message.asOrderedText()), textRenderer.fontHeight, message, textRenderer) {
    ...
    override fun renderText(context: DrawContext, textConsumer: DrawnTextConsumer, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        textConsumer.text(k, l, orderedText)
    }
